...
(async function () {
    ...
    const PVP_SKILLS = {
        ...
        // Hunter Skills
        '9':  { name: "Back Stab",  cost: 3, type: "attack",  target: "enemy",      icon: "/images/skills/Back Stab.webp" },
        '9':  { name: "Killer Instinct",  cost: 5, type: "attack",  target: "enemy",      icon: "/images/skills/Killer Instinct.webp" },
    };
